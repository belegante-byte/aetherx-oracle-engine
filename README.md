...
Aether-X exposes congestion scores, ETA delay estimates, freight volatility indices and modeled daily demurrage exposure for 19 global ports — delivered through a **REST API**, a **typed Python SDK** and a **remote MCP server** for AI agents.
