...
Aether-X is **live physical-world port intelligence** — port congestion signal, vessel queue intelligence, port delay risk / ETA delay, and demurrage exposure — for 19 global ports, delivered through a **REST API**, a **typed Python SDK** and a **remote MCP server** for AI agents.
