...
> **Política do projeto: FREE-ONLY** — nenhum custo de submissão. Tiers pagos de diretórios (ex.: mcp.so $39 one-time) são recusados por padrão; só com decisão explícita do operador.
