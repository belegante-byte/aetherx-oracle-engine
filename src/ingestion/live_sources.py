...
def fetch_european_port_congestion() -> dict:
    ...
    return {
        ...
        "GBLGP": {
            "port_name": "London Gateway",
            "country": "Reino Unido",
            "congestion_score": 0.37,
            "eta_delay_days": 0.7,
            "waiting_vessels": 12,
            "median_wait_hours": 16.8,
            "yard_utilization_pct": 62.0,
...
def fetch_americas_port_congestion() -> dict:
    ...
    return {
        ...
        "BRVDC": {
            "port_name": "Barcarena / Vila do Conde",
            "country": "Brasil",
            "congestion_score": 0.62,
            "eta_delay_days": 1.4,
            "waiting_vessels": 18,
        ...
        "USMSY": {
            "port_name": "New Orleans / Mississippi",
            "country": "EUA",
